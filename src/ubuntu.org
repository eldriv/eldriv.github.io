...
<h1 class="title">How I installed Ubuntu From Windows</h1>
</header>
#+END_EXPORT
#+language: en
#+startup: overview
...
- [[#go-to-ubuntu-website][Go to Ubuntu website]]
- [[#create-a-bootable-usb-drive-to-install-bare-metal-linux][Create a bootable USB drive to install bare-metal Linux]]
- [[#boot-process-installation][Boot Process & Installation]]
