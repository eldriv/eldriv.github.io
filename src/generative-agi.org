...
#+HTML_HEAD: <meta property="og:title" content="We're Not One Prompt Away from AGI">
#+HTML_HEAD: <meta property="og:url" content="https://eldriv-blogs.netlify.app/en/generative-agi/">
#+HTML_HEAD: <meta property="og:image" content="https://eldriv-blogs.netlify.app/img/agi-icon.png">
#+HTML_HEAD: <meta property="og:description" content="Why scaling generative AI is the wrong path to AGI, and what brute force in data centers leaves unsolved.">
...
The talk behind a lot of this post is [[https://www.youtube.com/watch?v=CGxbRJPCoAQ][Artificial Intelligence: a Problem of Plumbing?]] by Gerald Jay Sussman ([[https://www.european-lisp-symposium.org/2023/][ELS 2023]]). He is not saying AI failed. He is asking why we still cannot connect strong pieces so they work together on problems that need more than one kind of skill.
...
AGI, if it arrives, will need more than a bigger prompt window. It will need answers to questions we are still largely treating as side quests. That is the path worth walking. If you want the source that shaped my thinking, watch Sussman's [[https://www.youtube.com/watch?v=CGxbRJPCoAQ][plumbing talk on YouTube]].
