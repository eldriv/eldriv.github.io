#+title: Building 'ems' in Common Lisp with Clingon
#+author:
#+BEGIN_EXPORT html
...
The code we will create in this section will be stored in a file called [[https://github.com/eldriv/ems/blob/main/src/ems.lisp][ems.lisp]].
* Installation
