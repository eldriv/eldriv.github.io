...
- [[#nixos-a-built-different-linux-distro][NixOS—A built different Linux distro]]
- [[#preparation][Preparation]]
- [[#iso-image][ISO image]]
- [[#usb][USB]]
- [[#execution][Execution]]
- [[#faced-issues][Faced Issues:]]
- [[#installing-nix-packages][Installing Nix Packages]]
- [[#nix-commands][Nix commands]]
- [[#flakes][Flakes]]
- [[#whats-inside-a-flake][What's inside a flake?]]
- [[#why-use-nix-flakes][Why use nix flakes?]]
- [[#example-of-a-simple-flake-nix-file][Example of a simple flake.nix file]]
